...
<p>
    ...
    <a href="https://github.com/mattcmaddox/Clawde"><img src="https://img.shields.io/badge/Version-0.1.9-2E8B57?style=for-the-badge" alt="Version 0.1.9"></a>
...
> [!IMPORTANT]
> **Clawde is now officially in Beta (v0.1.9).** The core agent, multi-provider routing, and TUI are stable enough for daily driving — expect rough edges around experimental features (flagged below). Bug reports and PRs welcome.
