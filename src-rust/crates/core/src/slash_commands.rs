...
pub const PROMPT_COMMANDS: &[PromptCommand] = &[
    ...
    PromptCommand { name: "katban", description: "Control Katban: boards, projects, sites, status", category: "Commands", tui_only: false },
    ...
    PromptCommand { name: "chat", description: "Open the Cat Chat guest-link manager", category: "Commands", tui_only: false },
    ...
    PromptCommand { name: "ollama", description: "Open the Ollama screen (config | status | online | isolated | refresh | discover)", category: "Model & Provider", tui_only: false },
