// tips.rs — Tip scheduling system for Clawde.
//
// Ported from:
...
//
// Tips are shown during the spinner while Clawde is processing.  Each tip has
// a `cooldown_sessions` field — the tip won't be shown again until that many
// sessions have passed since the last display.
//
// History is persisted to `~/.clawde/tip_history.json`.
...
static ALL_TIPS: Lazy<Vec<Tip>> = Lazy::new(|| {
    vec![
        Tip {
            id: "new-user-warmup",
            content: "Start with small features or bug fixes, tell Clawde to propose a plan, and verify its suggested edits",
            cooldown_sessions: 3,
        },
        Tip {
        ...
        Tip {
            id: "git-worktrees",
            content: "Use git worktrees to run multiple Clawde sessions in parallel.",
            cooldown_sessions: 10,
        },
        Tip {
            id: "color-when-multi-clauding",
            content: "Running multiple Clawde sessions? Use /color and /rename to tell them apart at a glance.",
            cooldown_sessions: 10,
        },
        Tip {
            id: "shift-enter",
        ...
        Tip {
            id: "memory-command",
            content: "Use /memory to view and manage Clawde memory",
        ...
        Tip {
            id: "prompt-queue",
            content: "Hit Enter to queue up additional messages while Clawde is working.",
            cooldown_sessions: 5,
        },
        Tip {
            id: "enter-to-steer-in-realtime",
            content: "Send messages to Clawde while it works to steer Clawde in real-time",
            cooldown_sessions: 20,
        },
        Tip {
            id: "todo-list",
            content: "Ask Clawde to create a todo list when working on complex tasks to track progress and remain on track",
            cooldown_sessions: 20,
        },
        Tip {
            id: "permissions",
        ...
        Tip {
            id: "custom-commands",
            content: "Create skills by adding .md files to .clawde/skills/ in your project or ~/.clawde/skills/ for skills that work in any project",
            cooldown_sessions: 15,
        },
        Tip {
            id: "shift-tab",
...
impl TipHistory {
    /// Path to the persisted history file: `~/.clawde/tip_history.json`.
    fn history_path() -> Option<std::path::PathBuf> {
        Some(crate::config::Settings::config_dir().join("tip_history.json"))
    }

    /// Load history from `~/.clawde/tip_history.json`.
    ...
    /// Persist history to `~/.clawde/tip_history.json`.
