// share_export: Render a Clawde session as a single self-contained HTML file
...
// `https://mattcmaddox.github.io/Clawde/session/#<gist-id>` (overridable via
// `CLAWDE_SHARE_VIEWER_URL`).
...
/// Default viewer base URL used when `CLAWDE_SHARE_VIEWER_URL` is unset.
pub const DEFAULT_SHARE_VIEWER_URL: &str = "https://mattcmaddox.github.io/Clawde/session/";

/// Environment variable that overrides the share viewer base URL.
pub const ENV_SHARE_VIEWER_URL: &str = "CLAWDE_SHARE_VIEWER_URL";
...
/// Build the viewer URL for a given gist id, honoring `CLAWDE_SHARE_VIEWER_URL`.
...
mod tests {
    ...
    fn viewer_url_default_and_override() {
        ...
        assert_eq!(
            ...
            "https://mattcmaddox.github.io/Clawde/session/#deadbeef"
        );
