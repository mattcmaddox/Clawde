...
pub const FREE_CATALOG: &[FreeUpstream] = &[
    ...
    FreeUpstream {
        id: "modelscope",
        title: "ModelScope",
        key_url: "modelscope.cn",
        default_model: "Qwen/Qwen3-235B-A22B-Instruct",
        model_family: "qwen3-235b",
        note: "Qwen3 235B — 2K RPD free, no credit card",
        tool_calling: true,
        vision: false,
        max_tokens_cap: Some(8_192),
