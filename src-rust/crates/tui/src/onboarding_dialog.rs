...
fn render_provider_setup_page(frame: &mut Frame, area: Rect) {
    ...
    let pink = crate::overlays::CLAWDE_ACCENT;
...
fn render_welcome_page(frame: &mut Frame, area: Rect) {
    ...
    let lines: Vec<Line<'static>> = vec![
        ...
        Line::from(""),
        Line::from(Span::styled(
            "  Clawde is an AI-powered coding assistant in your terminal.",
        ...
        Line::from(Span::styled(
            "  Clawde can read, edit, and create files in your project.",
            Style::default().fg(text),
        )),
        Line::from(Span::styled(
            "  Clawde can run bash commands, search the web, and more.",
            Style::default().fg(text),
        )),
        Line::from(""),
        Line::from(Span::styled(
...
mod tests {
    ...
    fn onboarding_renders_without_panic() {
        ...
        let content: String = terminal
            ...
            .collect();
        assert!(content.contains("Welcome") || content.contains("Clawde"));
    }
